				...
				>
					...
					>
						...
						<p className='px-[20px] sm:px-[45px] md:px-[82px] xl:px-0'>
							...
							уединение и прохладу среди деревьев в лесу.
							<br />
							<br />
							Важно, чтобы каждая мини-группа нашла для себя комфортное место,
							но при этом учитывала, что рядом будут находиться наши же ребята.
							Давайте постараемся распределиться так, чтобы всем было удобно и
							приятно. Это поможет нам сохранить ощущение единства и дружной
							компании, несмотря на то, что мы будем разбросаны по разным
							уголкам пляжа.
						</p>
					</div>
				</aside>
